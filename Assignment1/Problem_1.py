...
#
# print (square)
print("Code 6: this is invalid syntax because def indicates a function is going to be produced so you need to set proper conditions")
#Code7
#print "Hello there"
...
#Code 8
#x= (1 * 2 * 4))
print("Code 8: this is similar to Code8, it's an incomplete/hanging command, but the parenthesis is missing in the beginning")
#Code 9
#1tomato = 1
